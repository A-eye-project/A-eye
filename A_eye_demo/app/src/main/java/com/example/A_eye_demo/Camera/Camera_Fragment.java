package com.example.A_eye_demo.Camera;
...
public class Camera_Fragment extends Fragment
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        Log.i("target","SetupCameraOutput");
    }
    ...
    private void createCameraPreviewSession() {
        try {
            ...
            Log.i("target","createCarmera");
            pictureHandler = new Handler();
            pictureHandler.postDelayed(new Runnable(){ // 촬영시간 지연
                @Override
                public void run(){
                    takePicture();
                }
        ...
        try {
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                    ...
                    Data_storage.img_path = mFile.toString();
